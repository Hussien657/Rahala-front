        ...
        <CardContent>
          <div className="space-y-3 text-sm text-gray-600">
            ...
            <div className={`flex items-start ${direction === 'rtl' ? 'space-x-reverse' : ''} space-x-2`}>
              ...
              <div>
                <strong>
                  <TranslatableText staticKey="searchStats.tagSearchTip">Search in tags: Search for keywords like 'adventure' or 'travel'</TranslatableText>
                </strong>
              </div>
            </div>
            <div className={`flex items-start ${direction === 'rtl' ? 'space-x-reverse' : ''} space-x-2`}>
              ...
              <div>
                <strong>
                  <TranslatableText staticKey="searchStats.filterTip">Use filters: To narrow search by country or followers count</TranslatableText>
                </strong>
              </div>
            </div>
            <div className={`flex items-start ${direction === 'rtl' ? 'space-x-reverse' : ''} space-x-2`}>
              ...
              <div>
                <strong>
                  <TranslatableText staticKey="searchStats.quickSearchTip">Quick search: Start typing at least 2 characters for suggestions</TranslatableText>
                </strong>
              </div>
            </div>
          </div>
